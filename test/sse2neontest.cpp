...
{
	ASSERT_EQ(equals(_mm_and_si128(
		vU64(0x1020304050607080, 0x0807060504030201),
		vU64(0x0102030405060708, 0x8070605040302010)),
		 vU64(0, 0)), true);
...
{
	ASSERT_EQ(equals(_mm_xor_si128(
		vU64(0x1020304050607080, 0x0807060504030201),
...
{
	ASSERT_EQ(equals(_mm_andnot_si128(
		vU64(0x1020304050607080, 0x0807060504030201),
		vU64(0xffffffffffffffff, 0xffffffffffffffff)),
		vU64(0xefdfcfbfaf9f8f7f, 0xf7f8f9fafbfcfdfe)), true);
}
...
{
	ASSERT_EQ(equals(_mm_set_epi8(0xf, 0xe, 0xd, 0xc, 0xb, 0xa, 0x9, 0x8, 0x7, 0x6, 0x5, 0x4, 0x3, 0x2, 0x1, 0x0),
...
{
	ASSERT_EQ(equals(_mm_cmpeq_epi8(
...
{
	ASSERT_EQ(equals(_mm_cmpgt_epi8(
...
{
	ASSERT_EQ(equals(_mm_cmpeq_epi16(
		vS16(-1, 11, 0, 124, 125, -124, -125, 100),
		vS16(-1, 22, 0,   0, 123, -123, -100, -100)),
		vU16(0xFFFF, 0, 0xFFFF, 0, 0, 0, 0, 0)), true);
}
...
TEST(SSE2NEONTest, _mm_slli_si128_test)
{
	...
	ASSERT_EQ(equals(_mm_slli_si128(a, 1), vU64(0x2030405060708008, 0x0706050403020100)), true);
	ASSERT_EQ(equals(_mm_slli_si128(a, 2), vU64(0x3040506070800807, 0x0605040302010000)), true);
	ASSERT_EQ(equals(_mm_slli_si128(a, 5), vU64(0x6070800807060504, 0x0302010000000000)), true);
...
{
	__m128i a = vU64(0x1020304050607080, 0x0807060504030201);
	ASSERT_EQ(equals(_mm_srli_si128(a, 1), vU64(0x0010203040506070, 0x8008070605040302)), true);
	ASSERT_EQ(equals(_mm_srli_si128(a, 2), vU64(0x0000102030405060, 0x7080080706050403)), true);
	ASSERT_EQ(equals(_mm_srli_si128(a, 5), vU64(0x0000000000102030, 0x4050607080080706)), true);
}
...
TEST(SSE2NEONTest, _mm_slli_epi64_test)
{
	...
	ASSERT_EQ(equals(_mm_slli_epi64(a, 8), vU64(0x2030405060708000, 0x0706050403020100)), true);
	ASSERT_EQ(equals(_mm_slli_epi64(a, 16), vU64(0x3040506070800000, 0x0605040302010000)), true);
	ASSERT_EQ(equals(_mm_slli_epi64(a, 40),vU64(0x6070800000000000, 0x0302010000000000)), true);
...
{
	__m128i a = vU64(0x1020304050607080, 0x0807060504030201);
	ASSERT_EQ(equals(_mm_srli_epi64(a, 8), vU64(0x0010203040506070, 0x0008070605040302)), true);
	ASSERT_EQ(equals(_mm_srli_epi64(a, 16), vU64(0x0000102030405060, 0x0000080706050403)), true);
	ASSERT_EQ(equals(_mm_srli_epi64(a, 40),vU64(0x0000000000102030, 0x0000000000080706)), true);
}

TEST(SSE2NEONTest, _mm_slli_epi16_test)
{
	__m128i a = vU16(0x1020, 0x3040, 0x5060, 0x7080, 0x8070, 0x0605, 0x0403, 0x0201);
	ASSERT_EQ(equals(_mm_slli_epi16(a, 4), vU16(0x0200, 0x0400, 0x0600, 0x0800, 0x0700, 0x6050, 0x4030, 0x2010)), true);
}
...
{
	ASSERT_EQ(equals(_mm_add_epi16(
...
{
	ASSERT_EQ(equals(_mm_subs_epu8(
		vU8(0x12, 0x34, 0x43, 0x21, 0x87, 0x65, 0x56, 0x78, 0x00, 0x00, 0xff, 0xff, 0xfe, 0xdc, 0xab, 0xcd),
		vU8(0x43, 0x21, 0x87, 0x65, 0x56, 0x78, 0x12, 0x34, 0x00, 0x00, 0xff, 0xff, 0x00, 0x00, 0x12, 0x34)),
...
TEST(SSE2NEONTest, _mm_loadu_si128_test)
{
	...
	ASSERT_EQ(equals(_mm_loadu_si128((__m128i*)aa), vU8(0xcd, 0xab, 0xdc, 0xfe, 0xff, 0xff, 0x00, 0x00, 0x78, 0x56, 0x65, 0x87, 0x21, 0x43, 0x34, 0x12)), true);
}
...
TEST(SSE2NEONTest, _mm_storeu_si128_test)
{
	...
	__m128i b = vU8(0xcd, 0xab, 0xdc, 0xfe, 0xff, 0xff, 0x00, 0x00, 0x78, 0x56, 0x65, 0x87, 0x21, 0x43, 0x34, 0x12);
	
	ASSERT_EQ(memcmp(&aa, &b, sizeof(__m128i)), 0);
}
...
TEST(SSE2NEONTest, _mm_movpi64_epi64_test)
{
	...
	_mm_empty();
	ASSERT_EQ(equals(a, vU64(0x0, 0x123456789abcdef0)), true);
