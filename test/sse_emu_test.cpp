...
TEST(SSE_EMU_TEST, _mm_insert_epi64_test)
{
	...
	ASSERT_EQ(equals(_mm_insert_epi64(vS64(123456789, -987654321), 987654321, 0), vS64(123456789, 987654321)), true);
	ASSERT_EQ(equals(_mm_insert_epi64(vS64(123456789, -987654321), 987654321, 1), vS64(987654321, -987654321)), true);
}
...
{
	ASSERT_EQ(
		equals(_mm_cvtepu8_epi16(vU8(9, 9, 10, 11, 12, 13, 14, 15, 0, -1, 3, -3, 5, -5, 8, -7)),vS16(0, 255, 3, 253, 5, 251, 8, 249)), true);
}

TEST(SSE_EMU_TEST, _mm_min_epu16_test)
{
	ASSERT_EQ(equals(_mm_min_epu16(vU16(65535, 65534, 32767, 65534, 4, 5, 6, 7), 
...
{
	ASSERT_EQ(equals(_mm_shuffle_epi8(
...
TEST(SSE_EMU_TEST, _mm_comge_epi8_test)
{
	...
	ASSERT_EQ(equals(_mm_comge_epi8(
